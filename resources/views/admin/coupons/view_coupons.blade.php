            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">{{ $coupon->amount }}
                    @if($coupon->amount_type=='Percentage')% @else NR @endif
                  </td>
                  ...
                  <td class="center"> 
                    ...
                    <a{{--  id="delCoupon" onclick = "return delCoupon();" href="{{ url('/admin/delete-coupon/'.$coupon->id) }}" --}} rel="{{ $coupon->id }}" rel1="delete-coupon" href="javascript:" class="btn btn-danger btn-mini deleterecord">Delete</a>
                  </td>
                </tr>
                @endforeach
              </tbody>
