						...
						<div class="col-sm-5">
							<div class="view-product">
								<div class="easyzoom easyzoom--overlay easyzoom--with-thumbnails">
									<a class="mainImgLarge" href="{{asset('images/backend_images/products/large/'.$productDetails->image)  }}">
										<img  id="mainImg"   style="width: 300px;" src="{{asset('images/backend_images/products/medium/'.$productDetails->image)  }}" alt="" >
									</a>
								</div>
							</div>
									...
									<div class="item active thumbnails">
											...
											@foreach($productAltImages as $altImage)
												<a href="{{  asset('images/backend_images/products/large/'.$altImage->image)}}" data-standard="{{  asset('images/backend_images/products/small/'.$altImage->image)}}">
										  			<img class="changeImage" style="width: 80px; curser:pointer;" src="{{  asset('images/backend_images/products/small/'.$altImage->image)}}" alt="">
										  		</a>	
											@endforeach										 
									</div>										
								</div>								
						...
						<div class="col-sm-7">
								<form name="addtocartForm" id="addtocartForm" action="{{ url('add-cart')}}" method='post'>{{ csrf_field() }}
									...
									<div class="product-information"><!--/product-information-->
										...
										<span>
											<span id="getPrice">NR {{$productDetails->price}}</span>
					...
					<div class="category-tab shop-details-tab"><!--category-tab-->
						<div class="col-sm-12">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#description" data-toggle="tab">Descriptions</a></li>
